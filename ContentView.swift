    ...
    var body: some View {
        Button(action: {
            ...
            Text(self.dataSource.squareStatus == .home ?
                    "X" : self.dataSource.squareStatus == .visitor ? "O" : " ")
                .font(.largeTitle)
                .bold()
    ...
    var body: some View {
        VStack {
            ...
            Alert(title: Text("Game Over"),
                  message: Text(self.ticTacToeModel.gameOver.0 != .empty ? self.ticTacToeModel.gameOver.0 == .home ? "Congratulation! You won!": "AI Won!" : "Nobody Wins" ) , dismissButton: Alert.Button.destructive(Text("Ok"), action: {
